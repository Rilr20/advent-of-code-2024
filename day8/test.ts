...
function part_1_test_example_1(filename:string) {
    let file = getFile(`${filename}.txt`);
...
function run() {
    part_1_test_example_1("example")
    console.log();
    part_1_test_example_1("example2")
    console.log();
    part_1_test_example_1("example3")
    console.log();
    part_1_test_example_1("example4")
    console.log();
